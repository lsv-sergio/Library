...
namespace LibraryDomain.Queries.LinksQueries.Factory
{
    public class LinkFactory:ILinkFactory
    {
        ...
        public LinkFactory(IDalQueryFactory DalQueryFactory)
        {
        ...
        public TLink CreateLink<TLink>(int Id, string Name) where TLink :ILink
        {
            ...
            if (linkQueries == null)
                return default(TLink);
            return linkQueries.Create(Id, Name);
        }
